      ...
      {error && <Error/>}
        ...
        {!loading && !error && <div className="grid md:grid-cols-3 gap-[50px]"> 
          <div className=" md:col-span-2"> 
            ...
            <div>
                <span className="bg-[#CCF0F3] text-black py-1 px-2 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded">{specialization}</span>
          ...
          {
            tab=='feedback' && <FeedbackAbout reviews={reviews} totalRating={totalRating}/>
          }
          </div>
        </div>
        <div>
