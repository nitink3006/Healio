...
const ServiceCard = ({item,index}) => {
  ...
  return <div className="py-[30px] px-3 lg:px-5">
    <h2 className="text-[26px] leading-9 yexy-headingColor font-[700]">{name}</h2>
    ...
    <div className="flex items-center justify-between mt-[30px]">
        ...
        <span className="w-[44px] h-[44px] flex items-center justify-center text-[18px] laeding-[30px] font-[600]" style={{background: `${bgColor}`,color:`${textColor}`,borderRadius: "6px 0 0 6px",}}>
            {index+1}
        </span>
    </div>
  </div>
