...
const Profile = (doctorData) => {
  ...
  return (
            ...
            <div className="grid grid-cols-3 gap-5 mb-[30px]">
                ...
                <div>
                    ...
                    <select name="specialization" value={formData.specialization} onChange={handleInputChange} className="form__input py-3.5" >
                        ...
                        <option value="dermatalogy">Dermatalogist</option>
                    </select>
                </div>

                <div>
                    <p className="form__label"> Ticket Price*</p>
                    <input type="number" placeholder="100" name="ticketPrice" value={formData.ticketPrice} className="form_input " onChange={handleInputChange}></input>
                </div>
            </div>
        </div>
        <div className="mb-5">
            ...
            <div>
                <div className="grid grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="degree" value={item.degree}  placeholder="Degree Name" className="form__input"onChange={e => handleQualificationChange(e,index)} />
                        </div>
                        <div>
                        <p className="form__label">University*</p>
                        <input type="text" name="university" placeholder="University Name" value={item.university} className="form__input" onChange={e => handleQualificationChange(e,index)} />
                        </div>
                    </div>
          ...
          {formData.experiences?.map((item,index) => <div key={index}>
            <div>
                <div className="grid grid-cols-2 gap-5">
                    ...
                    <button onClick={e => deleteExperience(e,index)} className="bg-red-600 p-2 rounded-full text-white text-[16px] mt-2 mb-[30px] cursor-pointer">
                        <AiOutlineDelete/>
                    </button>
                </div>
            </div>)}
    ...
    <div className="relative w-[130px] h-[50px]">
        ...
        <div className="mt-7">
            <button type="submit" onClick={updateProfileHandler} className="bg-primaryColor text-white text-[18px] leading-[30px] w-full py-3 px-4 rounded-lg ">UpdateProfile</button>
        </div>
        </form>
    </div>
  );
